...
import 'package:project1/latihan/navigation_bar.dart';

import '../model/model_pegawai.dart';
import '../page_bottom_navigation.dart';
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
          Uri.parse("http://192.168.35.167/edukasi_server/getPegawai.php"));
                                    ...
                                    actions: <Widget>[
                                      ...
                                      TextButton(
                                        onPressed: () {
                                          ...
                                          http.post(
                                            Uri.parse('http://192.168.35.167/edukasi_server/deletePegawai.php'),
                ...
                ElevatedButton(
                  onPressed: () {
                    if (keyForm.currentState?.validate() == true) {
                      ...
                      http.post(
                        Uri.parse('http://192.168.35.167/edukasi_server/simpanPegawai.php'),
                        body: dataKaryawan,
                      ).then((response) {
                        // Memeriksa respons dari server
                        if (response.statusCode == 200) {
